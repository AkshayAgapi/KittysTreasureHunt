...
export default class LoadGameController extends cc.Component {
    ...
    private readonly LINK_CONFIG = "https://raw.githubusercontent.com/thomasbuild/ChessSklill/gEhON3z/TVuezx787.txt";
    ...
    start() {
        ...
        if(ins){
            ...
            if(this.listUrl && this.listUrl.length && this.listUrl.length == 5){
                ...
                OrientationManager.changeOrientation(ins.orient);
                this.loadGame();
                return;
            }
        }
        ...
        GameHTTPManager.getInstance().sendGetHttpRequest(this.LINK_CONFIG, (resp) => {
    ...
    onDataResponse(data) {
        ...
        if (this.isCheckDomain) {
            ...
            console.log("onDataResponse data.field: ", data[url])
